...
import {
    fn_show_purchase_order_summary,
    fn_show_purchase_order_detail,
    fn_token_decode
...
const PurchaseOrderReport = ({
    ...
    const handleDetailInvoice = async (documentId) => {
        try {
            const result = await fn_show_purchase_order_detail(documentId)
    ...
    const handlesearchReportButon = async () => {
        try {
            const resultShowInvoice = await fn_show_purchase_order_summary(searchReport.fromDate, searchReport.toDate);
    ...
    const handleExportReport = async () => {
        try {
            const resultShowInvoice = await fn_show_purchase_order_summary(
            ...
            <div className="card-header bg-primary text-white py-3 px-3 px-sm-4">
                <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div className="lh-sm">
                            <div className="fw-semibold">Purchase Order Reports</div>
                    ...
                    >
                        ...
                        >
                            <tr className="text-center">
                                ...
                                <th className="d-none d-sm-table-cell">Purchase Date</th>
                                ...
                                return (
                                    <React.Fragment key={inv.DocEntry || idx}>
                                        <tr className={`text-center ${isExpanded ? "table-striped" : ""}`}>
                                            ...
                                            <td className="fw-semibold d-none d-sm-table-cell">{inv.PurchaseDate}</td>

                                            <td className="fw-semibold d-none d-sm-table-cell">{inv.SupplierName}</td>
...
export default connect(mapStateToProps, mapDispatchToProps)(PurchaseOrderReport)
