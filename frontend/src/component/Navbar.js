                    ...
                    <nav className="navbar navbar-expand-lg bg-body-tertiary">
                        <div className="container-fluid">
                            <Link className="navbar-brand">
                                <img src="OpenMenu.gif" alt="SAP Logo" width="30px" height="30px" className="d-inline-block align-text-top" onClick={handlehomePage} />
                            </Link>
                                    ...
                                    <form className="d-flex" role="search">
                                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                            ...
                                            <li className="nav-item">
                                                <p className='my-2'><strong>{result.tokenUserName}</strong></p>
                                            </li>
                                ...
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item mb-2">
                                        <button
                                            ...
                                            data-bs-target="#ItemMaster"
                                            aria-expanded="false"
                                        >
                                            <i className="bi bi-people"></i> Products Master
                                        </button>
                                        <div className="collapse ps-4" id="ItemMaster">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                <li className="nav-item mb-2">
                                                    ...
                                                    >
                                                        <i className="bi bi-person-badge"></i> Categories
                                                    </Link>
                                                </li>
                                    ...
                                    <li className="nav-item mb-2">
                                        <button
                                            ...
                                            aria-expanded="false"
                                        >
                                            <i className="bi bi-cart-check"></i> Sales
                                        </button>
                                        <div className="collapse ps-4" id="Sales">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                <li className="nav-item mb-2">
                                                    <Link
                                                        className="nav-link d-flex align-items-center gap-2"
                                    ...
                                    {/* <li className="nav-item mb-2">
                                        ...
                                        <div className="collapse ps-4" id="Payments">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                <li className="nav-item mb-2">
                                                    <Link
                                                        className="nav-link d-flex align-items-center gap-2"
                                                        data-bs-dismiss="offcanvas"
                                                        aria-label="Close"
                                                        onClick={() => { navigate('/incpayment') }}
                                                    >
                                                        <i className="bi bi-arrow-down-circle"></i> Incoming Payment
                                                    </Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    {/* <li className="nav-item mb-2">
                                        ...
                                        <div className="collapse ps-4" id="reportsCollapse">
                                            <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                <li>
                                                    <Link
                                                        className="nav-link d-flex align-items-center gap-2"
                                                        data-bs-dismiss="offcanvas"
                                                        aria-label="Close"
                                                        onClick={() => { navigate('/saleinvoicereports') }}
                                                    >
                                                        <i className="bi bi-journal-text"></i> Invoices
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link
                                                        ...
                                                        data-bs-dismiss="offcanvas"
                                                        aria-label="Close"
                                                        onClick={() => { navigate('/incomingpaymentreport') }}
                                                    >
                                                        <i className="bi bi-file-earmark-bar-graph"></i> Payment Report
                                                    </Link>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    {/* <li className="nav-item mb-2">
                                        <button
                                            ...
                                            aria-expanded="false"
                                        >
                                            <i className="bi bi-shield-lock"></i> Administrator
                                        </button>
                                        <div className="collapse ps-4" id="adminCollapse">
                                            <button
                                                className="nav-link d-flex align-items-center gap-2 w-100 btn btn-toggle align-items-center rounded collapsed"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#adminCollapseInner"
                                                aria-expanded="false"
                                            >
                                                <i className="bi bi-shield-lock"></i> Admin
                                            </button>

                                            <div className="collapse ps-4" id="adminCollapseInner">
                                                <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                    <li>
                                                        <Link
                                                            className="nav-link d-flex align-items-center gap-2"
                                                            data-bs-dismiss="offcanvas"
                                                            aria-label="Close"
                                                            onClick={() => { navigate('/wasetup') }}
                                                        >
                                                            <i className="bi bi-whatsapp me-1"></i> WA Setup
                                                        </Link>
                                                    </li>
                                            ...
                                            <div className="collapse ps-4" id="adminCollapseInner">
                                                <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                    <li>
                                                        ...
                                                        >
                                                            <i className="bi bi-diagram-3 me-1"></i> Branch Setup
                                                        </Link>
                                                    </li>
                                            ...
                                            <button
                                                className="nav-link d-flex align-items-center gap-2 w-100 btn btn-toggle align-items-center rounded collapsed"
                                                data-bs-toggle="collapse"
                                                data-bs-target="#numberingSeriesCollapse"
                                                aria-expanded="false"
                                            >
                                                <i className="bi bi-123 me-1"></i> Numbering Series
                                            </button>
                                            <div className="collapse ps-4" id="numberingSeriesCollapse">
                                                <ul className="btn-toggle-nav list-unstyled fw-normal small">
                                                    <li>
                                                        <Link
                                                            className="nav-link d-flex align-items-center gap-2"
                                                            data-bs-dismiss="offcanvas"
                                                            aria-label="Close"
                                                            onClick={() => { navigate('/numberingseries') }}
                                                        >
                                                            <i className="bi bi-123 me-1"></i> Numbering Series
                                                        </Link>
                                                    </li>
